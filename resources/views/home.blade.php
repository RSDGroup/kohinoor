...
<link rel="stylesheet" href="{{ asset('public/assets/admin/css/product.css') }}">
<link rel="stylesheet" href="{{ asset('public/assets/admin/css/store.css') }}">
<link rel="stylesheet" href="{{ asset('public/assets/admin/css/typewriter.css') }}">
<style>
...
.hero-section {
  background-image: url({{ asset('public/assets/backgrounds/image61.png')}});
...
.tab-icon {
  ...
  padding: 15px;
  object-fit: cover; /* Ensures the icon fits within the circle */
...
@keyframes gradientBackground {
  ...
  100% {
    background: linear-gradient(90deg, #4fbd90, #66d7a7); /* Greenish gradient */
  }
}

.tab-item:hover .tab-icon {
  animation: gradientBackground 0.5s forwards; /* Apply the gradient animation */
  transform: rotate(10deg); /* Tilt the icon 10 degrees on hover */
...
h3 {
  ...
  color: white;
    ...
    .video-section {
  position: relative;
  min-height: 100dvh; /* Modern fix for iOS 16+ */
...
video {
    ...
    object-fit: cover; /* Cover the entire container, cropping excess */
}
...
/* Responsive Typography for the Heading */
.welcome-heading {
    font-size: 1.5rem;
    color: #fff;
    margin-bottom: 10px;
...
.centered-text span {
    font-size: 20px; /* Apply specific styling to the span */
    color: #ccc; /* Example: Change color */
    font-weight: normal; /* Example: Make the span text normal weight */
    display: block; /* Optional: Display span on a new line */
    margin-top: 10px; /* Add space between heading and span */
}
...
.tab-view-item::before {
  ...
  width: 0;
  height: 100%;
  background: linear-gradient(90deg, #4fbd90, #66d7a7);
  z-index: 0;
...
.tab-view-item:hover {
  ...
  box-shadow: 0 12px 20px rgba(79, 189, 144, 0.2);
}

.tab-view-item.active {
  border: 2px solid #4fbd90;
}

.tab-view-item:hover::before {
  width: 100%;
}

/* Active state styling */
.tab-view-item.active::before {
  width: 100%;
}

.tab-view-item-content, 
.tab-view-item-icon {
  position: relative;
  z-index: 1;
}
...
.tab-view-item-icon {
  ...
  justify-content: center;
  border-radius: 50%;
  background-color: rgba(79, 189, 144, 0.1);
  transition: all 0.4s ease;
}

.tab-view-item-icon i {
  color: #4fbd90;
  font-size: 20px;
  transition: all 0.4s ease;
}

.tab-view-item:hover .tab-view-item-icon {
  background-color: rgba(255, 255, 255, 0.2);
  transform: rotate(10deg) scale(1.1);
}

.tab-view-item:hover .tab-view-item-icon i {
  color: white;
...
.tab-view-item:hover .tab-view-item-title,
.tab-view-item.active .tab-view-item-title {
  color: white;
}

.tab-view-item:hover .tab-view-item-description,
.tab-view-item.active .tab-view-item-description {
  max-height: 60px;
  opacity: 1;
...
.tab-view-item.new .tab-view-item-badge {
  opacity: 1;
  transform: scale(1);
}
...
.tab-view-item:nth-child(1) { animation-delay: 0.1s; }
.tab-view-item:nth-child(2) { animation-delay: 0.2s; }
.tab-view-item:nth-child(3) { animation-delay: 0.3s; }
.tab-view-item:nth-child(4) { animation-delay: 0.4s; }
...
.venture-item i {
    ...
    color: #4caf50; /* Customize the icon color */
    margin-right: 15px; /* Space between the icon and the text */
    background-color: white;
    border-radius: 50%; /* Makes the background a perfect circle */
    padding: 15px; /* Optional padding inside the circle */
    object-fit: cover; /* Ensures the icon fits within the circle */
    display: inline-block;
...
.venture-item p {
    line-height: 1.6;
    margin-top: 5px; /* Space between b and p */
}
...
.hero-container {
        ...
        @supports (-webkit-touch-callout: none) {
            .feature-tile {
                /* Fallback for Safari which may have issues with backdrop-filter */
                background-color: rgba(255, 255, 255, 0.2);
            }
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    ...
    {{-- <div id="preloader" class="preloader">
        <video autoplay muted >
            <source src="{{ asset('public/assets/videos/pre-loader.mp4') }}" type="video/mp4">
...
{{-- 
    <section class="banner-section position-relative">
        <div class="container">
            <div class="banner-content wow fadeInUp">
                ...
                <h1 class="title-type mb-1" style="color: #4caf50">
                    Manage Your Daily Life in one <span id="typewriter" style="color: #79242a">Platform</span>
                </h1>
    ...
    <div class="hero-container" style="z-index: 5;" >
        ...
        <div class="hero-content">
            <h1 style="color: #4caf50;">Welcome to Kohinoor Bazar</h1>
            <p>Discover a world of exceptional products with unmatched service. We're committed to bringing you the very best shopping experience, every time.</p>
        </div>
        
        <div class="features-grid">
            <div class="feature-tile" id="feature1">
                <div class="feature-icon">🚚</div>
                <div class="feature-title">Fast Delivery</div>
                <div class="feature-description">Get your orders quickly with our expedited shipping service.</div>
            </div>
            
            <div class="feature-tile" id="feature2">
                <div class="feature-icon">🛍️</div>
                <div class="feature-title">Wide Product Range</div>
                <div class="feature-description">Browse thousands of products across diverse categories.</div>
            </div>
            
            <div class="feature-tile" id="feature3">
                <div class="feature-icon">✅</div>
                <div class="feature-title">100% Satisfaction</div>
                <div class="feature-description">We guarantee your complete satisfaction with every purchase.</div>
            </div>
            
            <div class="feature-tile" id="feature4">
                <div class="feature-icon">🔒</div>
                <div class="feature-title">Secure Online Payments</div>
                <div class="feature-description">Shop with confidence using our encrypted payment system.</div>
            </div>
        </div>
    </div>
    ...
    <section class="store-section" >
        ...
        <div class="container">
            <div class="section-heading-container" data-aos="fade-up">
                <h2 class="section-heading">OUR STORES</h2>
                <p class="section-subheading">Visit our stores across Europe for authentic products and exceptional service</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="store-card">
                        <div class="store-image budapest mb-5">
                            <div class="map-container">
                                <!-- Street View Embed for Budapest -->
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!4v1713122880000!6m8!1m7!1sM8D5J1Hlax_3IT9h8c-0sQ!2m2!1d47.4941761!2d19.0709491!3f247.98!4f0!5f0.8160813932612223"
                                    allowfullscreen=""
                                    loading="lazy"
                        ...
                        <div class="store-content">
                            <h3 class="store-name">KOHINOOR BAZAAR | BUDAPEST</h3>
                            <div class="store-info">
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-content">
                                        ...
                                        <div class="info-text">
                                            <a href="tel:+3617879105" class="phone-button">
                                                <i class="fas fa-phone-alt"></i> +36 (1) 787 9105
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="info-item">
                                    ...
                                    <div class="info-content">
                                        ...
                                        <div class="info-text">1085 Budapest, József krt. 23</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="store-card">
                        <div class="store-image vienna mb-5">
                            <div class="map-container ">
                                <!-- Street View Embed for Budapest -->
                                <iframe
                                src="https://www.google.com/maps/embed?pb=!4v1713123300000!6m8!1m7!1sAF1QipNNPJIopzS_Dd82CdMRD1J4pIFnvqUMO-Bx3lCp!2m2!1d47.534938!2d21.6235906!3f326.5!4f0!5f0.8160813932612223"
                                width="100%"
                                height="200"
                        ...
                        <div class="store-content">
                            <h3 class="store-name">KOHINOOR BAZAAR | DEBRECEN</h3>
                            <div class="store-info">
                                <div class="info-item">
                                    <i class="fas fa-clock"></i>
                                    <div class="info-content">
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-content">
                                        <div class="info-label">Contact</div>
                                        <div class="info-text">
                                            <a href="tel:+4318904567" class="phone-button">
                                                <i class="fas fa-phone-alt"></i>+36 (30) 296 5720
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="info-item">
                                    ...
                                    <div class="info-content">
                                        <div class="info-label">Address</div>
                                        <div class="info-text">4026 Debrecen, Darabos Street 4</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="store-card">
                        <div class="store-image prague mb-5">
                            <div class="map-container">
                                <!-- Street View Embed for Budapest -->
                                <iframe
                                src="https://www.google.com/maps/embed?pb=!4v1713123400000!6m8!1m7!1sAF1QipNJY3eqbJDkyFkj6ZvMG_j4cKhU9H6YpBWKad8A!2m2!1d46.2557084!2d20.1457708!3f212.92!4f0!5f0.8160813932612223"
                                width="100%"
                                height="200"
                                style="border:0; border-radius:12px;"
                                allowfullscreen=""
                        ...
                        <div class="store-content">
                            <h3 class="store-name">KOHINOOR BAZAAR | SZEGED</h3>
                            <div class="store-info">
                                <div class="info-item">
                                    <i class="fas fa-clock"></i>
                                    <div class="info-content">
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-content">
                                        <div class="info-label">Contact</div>
                                        <div class="info-text">
                                            <a href="tel:+420225678901" class="phone-button">
                                                <i class="fas fa-phone-alt"></i> +36 (30) 916 0600
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="info-item">
                                    ...
                                    <div class="info-content">
                                        <div class="info-label">Address</div>
                                        <div class="info-text">6722 Szeged, Mérey Street 6B</div>
                                    </div>
                                </div>
                            </div>
   ...
   <div class="product-body" >
    <div class="showcase-container">
        <div class="background-decoration">
            <div class="background-circles">
                ...
                <div class="circle" style="width: 300px; height: 300px; top: -100px; left: -50px;"></div>
                <div class="circle" style="width: 200px; height: 200px; top: 50%; right: -50px;"></div>
                <div class="circle" style="width: 150px; height: 150px; bottom: 10%; left: 20%;"></div>
                <div class="circle" style="width: 250px; height: 250px; top: 30%; right: 30%;"></div>
            </div>
            <div class="wave-decoration"></div>
        </div>
        
        <div class="container py-5">
            <h2 class="product-showcase-heading animate__animated animate__fadeInDown">Premium Collection</h2>
            <p class="product-showcase-subheading animate__animated animate__fadeIn animate__delay-1s">Explore our carefully selected range of organic, halal-certified products made with the finest ingredients for your health and wellness.</p>
                    ...
                    <div class="product-img-container">
                        <div class="product-img-background">
                            <svg viewBox="0 0 400 220" xmlns="http://www.w3.org/2000/svg">
                                <defs>
                                    <pattern id="{{ $product->patternId }}" patternUnits="userSpaceOnUse" width="20" height="20" patternTransform="rotate(45)">
                                        <rect width="20" height="20" fill="{{ $product->patternColors['rect'] }}" fill-opacity="0.4"/>
                                        <circle cx="10" cy="10" r="2" fill="{{ $product->patternColors['circle'] }}" fill-opacity="0.4"/>
                                    </pattern>
                                </defs>
                                <rect width="100%" height="100%" fill="url(#{{ $product->patternId }})"/>
                                <!-- Decorative elements -->
                                <path d="M0,180 Q100,150 200,180 Q300,210 400,180" stroke="{{ $product->patternColors['circle'] }}" stroke-width="2" fill="none" stroke-opacity="0.3"/>
                                <path d="M0,150 Q100,180 200,150 Q300,120 400,150" stroke="{{ $product->patternColors['circle'] }}" stroke-width="2" fill="none" stroke-opacity="0.3"/>
                            </svg>
                        </div>
                        <img class="product-img" src="{{  $product['image_full_url'] }}" alt="{{ $product->name }}">
                        <!-- Sparkle effects -->
                        <div class="sparkle" style="width: 10px; height: 10px; top: 20%; left: 30%; animation-delay: 0s;"></div>
                        <div class="sparkle" style="width: 8px; height: 8px; top: 60%; left: 70%; animation-delay: 1s;"></div>
                        <div class="sparkle" style="width: 6px; height: 6px; top: 40%; left: 60%; animation-delay: 2s;"></div>
                    </div>
                    <div class="product-body">
                        <h5 class="product-title">{{$product->name}}</h5>
                        <p class="product-desc">{{$product->description}}</p>
                        <div class="price-container">
                            <span class="price">{{\App\CentralLogics\Helpers::format_currency($product->price)}}</span>
                        </div>
                        <div class="badge-container">
                            <span class="badge-halal">
                                ...
                                {{$product->is_halal ? 'Halal' : 'Non-Halal'}}
                            </span>
                            <span class="badge-organic">
                                <span class="badge-icon">
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M6 11.39V16C6 17.0609 6.42143 18.0783 7.17157 18.8284C7.92172 19.5786 8.93913 20 10 20C11.0609 20 12.0783 19.5786 12.8284 18.8284C13.5786 18.0783 14 17.0609 14 16V11.39" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </span>
                            ...
                            <div class="venture-content mt-4">
                                <div class="venture-content-box">
                                    <div class="venture-item">
                                        <i class="fa fa-shopping-cart"></i> <!-- Replace with your icon class -->
                                        <div>
                                            <b>More than 4000 + products</b>
                                            <p>Find the greatest deals from the grocery stores near you.</p>
                                        </div>
                                    </div>
                                    <div class="venture-item">
                                        <i class="fa fa-truck"></i> <!-- Replace with your icon class -->
                                        <div>
                                            <b>Fast Delivery</b>
                                    ...
                                    <div class="venture-item">
                                        <i class="fa fa-users"></i> <!-- Replace with your icon class -->
                                        <div>
                                            <b>Trusted by thousands of customers</b>
                                            <p>Start You'r Daily Shopping with Kohinoor</p>
                                        </div>
                                    </div>
                                    <div class="venture-item">
                                        <i class="fa fa-lock"></i> <!-- Replace with your icon class -->
                                        <div>
                                            <b>Secured online payments</b>
                                            <p>Start You'r Daily Shopping with Kohinoor</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {{-- <div class="venture-img mx-1"> --}}
                                <div class="video-container">
                                    <video autoplay muted loop>
                                        <source src="{{ asset('public/assets/videos/video-2.mp4') }}" type="video/mp4">
                                        Your browser does not support the video tag.
                                    </video>
                                    <div class="overlay1">
                                        <h1 class="centered-text">Everything you need - in one place. <br>
                                            <span>From our store to your table! </span>  </h1>
                                    </div>
                                </div>
    ...
    {{-- sponsored section start here  --}}

 {{-- <div class="container">
    <div class="swiper-container">
        <div class="swiper-wrapper" >
            <div class="swiper-slide"><img src="{{asset('public/assets/vendor-logos/1.png')}}" alt="Logo 1"></div>
            <div class="swiper-slide"><img src="{{asset('public/assets/vendor-logos/2.png')}}" alt="Logo 2"></div>
            <div class="swiper-slide"><img src="{{asset('public/assets/vendor-logos/3.png')}}" alt="Logo 3"></div>
            <div class="swiper-slide"><img src="{{asset('public/assets/vendor-logos/4.png')}}" alt="Logo 4"></div>
            <div class="swiper-slide"><img src="{{asset('public/assets/vendor-logos/5.png')}}" alt="Logo 5"></div>
            <div class="swiper-slide"><img src="{{asset('public/assets/vendor-logos/6.png')}}" alt="Logo 6"></div>
            <div class="swiper-slide"><img src="{{asset('public/assets/vendor-logos/7.png')}}" alt="Logo 7"></div>
            <div class="swiper-slide"><img src="{{asset('public/assets/vendor-logos/8.png')}}" alt="Logo 8"></div>
            <div class="swiper-slide"><img src="{{asset('public/assets/vendor-logos/9.png')}}" alt="Logo 9"></div>
        </div>
      </div>
 </div> --}}
    
    {{-- sponsored section end here  --}}
                ...
                <div class=" col-lg-6 pe-lg-5">
                    <div class="learn-feature-content wow fadeInUp">
                        <div class="section-header text-start mb-0">
                            <h1 class="title">{{ $landing_data['feature_title'] }}</span></h1>
                            {{-- <div class="text">
                ...
                <div class="col-lg-7 col-xl-6 text-lg-end">
                    <div class="refer-img">
                        ...
                        <svg class="main-img" viewBox="0 0 518 382" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M216.182 107.838H218.275L218.461 105.745H216.369L216.182 107.838Z"
                                fill="#039D55" />
                            <path
    ...
    <section class="earn-money-section">
        ...
        <svg class="e-shape-2" width="428" height="1099" viewBox="0 0 428 1099" fill="none"
            ...
            <g opacity="0.19">
                ...
                <path
                    d="M108.933 436.915L108.071 423.281C116.031 424.295 120.588 429.656 124.596 435.925L108.933 436.915Z"
    ...
    {{-- Kohinoor Bazar section starts  --}}

    <section class="hero-section mb-5 mt-5">
        <div class="content-wrapper">
          <h1 class="main-heading text-white">Kohinoor Bazar, More Than Just A Store</h1>
          <hr>
          <p class="subtext">Ecology is our long-term strategy and a huge value we stand for.</p>
          
          <div class="tabs-grid">
            <!-- Tab 1 -->
            <div class="tab-item">
              <img src="{{ asset('public/assets/kohinoor/1.png') }}" alt="Icon 1" class="tab-icon">
              <h3>Eco- friendly Bags</h3>
            </div>
            <!-- Tab 2 -->
            <div class="tab-item">
              <img src="{{ asset('public/assets/kohinoor/2.png') }}" alt="Icon 2" class="tab-icon">
              <h3>Best Quality Products</h3>
            </div>
            <!-- Tab 3 -->
            <div class="tab-item">
              <img src="{{ asset('public/assets/kohinoor/3.png') }}" alt="Icon 3" class="tab-icon">
              <h3>Fast Delivery</h3>
            </div>
            <!-- Tab 4 -->
            <div class="tab-item">
              <img src="{{ asset('public/assets/kohinoor/4.png') }}" alt="Icon 4" class="tab-icon">
              <h3>Minimizing Food Wastage</h3>
            </div>
            <!-- Tab 5 -->
            <div class="tab-item">
              <img src="{{ asset('public/assets/kohinoor/5.png') }}" alt="Icon 5" class="tab-icon">
              <h3>Multiple Store Locations</h3>
            </div>
            <!-- Tab 6 -->
            <div class="tab-item">
              <img src="{{ asset('public/assets/kohinoor/6.png') }}" alt="Icon 6" class="tab-icon">
                ...
                <div class="contact-wrapper-inner">
                    <div class="left-side">
                        <div class="counter-item wow fadeInUp">
                            <div class="icon">
                                <img height="50px" width="50px" src="{{asset('public/assets/counters/brands.png')}}" alt="">
                        ...
                        <div class="counter-item wow fadeInUp">
                            <div class="icon">
                                <img height="50px" width="50px" src="{{asset('public/assets/counters/stores.png')}}" alt="">


                            </div>
                            <h4 class="title"> <span class=" odometer" data-odometer-final="{{$counter['seller_count_numbers'] ?? 0}}"></span> 
                            </h4>
                        ...
                        <div class="counter-item wow fadeInUp">
                            <div class="icon">
                                <img height="50px" width="50px" src="{{asset('public/assets/counters/products.png')}}" alt="">


                            </div>
                            <h4 class="title"> <span class=" odometer" data-odometer-final="4000"></span> <span>+</span>
                            </h4>
                        ...
                        <div class="counter-item wow fadeInUp">
                            <div class="icon">
                                <img height="50px" width="50px" src="{{asset('public/assets/counters/customers.png')}}" alt="">
            ...
            <div class="row justify-content-center g-4">
                <div class="col-lg-6 col-md-9">
                    <div class="download-app-content wow fadeInUp">
                        <h2 class="title">Make Kohinoor Bazar</h2>
                        <h3 class="subtitle">A Part Of Your Family!</h3>
                        <img width="350px" height="350px" src="{{asset('public/assets/qr-code.png')}}" alt="">
                        <h3 class="subtitle">Download Our App Now! </h3>
                        {{-- <div class="btn-grp">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="video-container1">
                        <video autoplay muted loop>
                            <source src="{{ asset('public/assets/video71.mp4') }}" type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
                        <div class="overlay1">
                            <h1 class="centered-text">Your Family Needs,
...
<script>
   var swiper = new Swiper('.swiper-container', {
    slidesPerView: 5,  // Enable continuous flow
    spaceBetween: 0,        // No space between slides for smoothness
    loop: true,             // Infinite loop
    autoplay: {
        delay: 0,           // No delay between slides for continuous effect
        disableOnInteraction: false, // Keep autoplay on interaction
    },
    speed: 3000,            // Increase speed for smoother transitions (5 seconds)
    breakpoints: {
        // Responsive settings
        0: {
...
<script>
  ...
  const tabItems = document.querySelectorAll('.tab-view-item');
  
  // Add click handler to each tab item
  tabItems.forEach(item => {
    // Ripple effect on click
    item.addEventListener('click', function(e) {
      // Toggle active state
      document.querySelectorAll('.tab-view-item').forEach(tab => {
      ...
      // Example: Trigger any action when tab is clicked
      const tabId = this.getAttribute('data-tab-id');
      console.log(`Tab ${tabId} was clicked`);
      
      // You could update content based on the selected tab
      // updateContent(tabId);
    });
  ...
  // Optional: Automatically cycle through tabs for showcase
  let currentTabIndex = 0;
  const autoCycleInterval = 5000; // 5 seconds
  ...
  // const cycleInterval = setInterval(autoCycleTabs, autoCycleInterval);
  ...
  function playHoverSound() {
    ...
    hoverSound.src = 'path-to-your-sound.mp3'; // Replace with actual sound file
  ...
  // Mark some tabs as new (example)
  function markNewItems() {
    // This could be dynamic based on your data
    const newItems = [1, 3]; // Tab indexes to mark as new
    
    newItems.forEach(index => {
      if (tabItems[index]) {
        tabItems[index].classList.add('new');
      }
    });
  }
...
<script>
      document.querySelectorAll('.feature-tile').forEach(tile => {
        ...
        // Fix for iOS Safari video autoplay issues
        document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function type() {
        ...
        if (isDeleting) {
          ...
          charIndex--;
          typeDelay = 80; // Faster when deleting
        } else {
          // Adding characters
          typewriterElement.textContent = currentWord.substring(0, charIndex + 1);
          charIndex++;
          typeDelay = 150; // Normal speed when typing
        }
        ...
        if (!isDeleting && charIndex === currentWord.length) {
          ...
          isDeleting = true;
          typeDelay = 1500; // Wait before deleting
        } 
      ...
      container.addEventListener('mousemove', function(e) {
        ...
        container.style.transform = `perspective(1000px) rotateX(${xRotation}deg) rotateY(${yRotation}deg) translateY(-10px)`;
      });
