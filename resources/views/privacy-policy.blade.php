    ...
    <div class="container">
        <div class="policy-container">
            ...
            <div class="language-toggle">
                <button class="lang-btn active" style="color:rgb(57, 55, 55);" onclick="toggleLanguage('hu')">Hungarian</button>
                <button class="lang-btn" style="color:rgb(57, 55, 55);" onclick="toggleLanguage('en')">English</button>
            </div>
